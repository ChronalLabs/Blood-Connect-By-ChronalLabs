"""
BloodConnect Django Settings
Production-ready configuration with SQLite (dev) and PostgreSQL (prod) support
"""
...
# Fallback for Windows local testing if Redis isn't running
